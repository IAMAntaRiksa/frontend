<template>
    <svg class="max-w-2xl mx-auto hidden lg:block" viewBox="0 0 1050 642" version="1.1"
        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-v-549317c7="">
        <g id="deco-screen" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" data-v-549317c7="">
            <g id="artwork" data-v-549317c7="">
                <path d="M767,158 C837.170772,158.182154 894,212.285233 894,278.996688 L894,279 L767,279 L767,158 Z"
                    :style="{ fill: '#4caf50' }" data-v-549317c7=""></path>{" "}
                <path d="M767,279 C767.001743,345.719735 823.830971,399.81619 894,400 L894,279 L767,279 Z"
                    :style="{ fill: '#4caf50' }" data-v-549317c7=""></path>{" "}
                <path d="M1021,279 C1020.99826,345.719735 964.169029,399.81619 894,400 L894,279 L1021,279 Z"
                    :style="{ fill: '#ffa000' }" data-v-549317c7=""></path>{" "}
                <path d="M1021,158 C950.830971,158.182154 894,212.285233 894,278.996688 L894,279 L1021,279 L1021,158 Z"
                    :style="{ fill: '#ff6f00' }" data-v-549317c7=""></path>{" "}
                <path d="M767,521 C767.001743,454.280117 823.830971,400.18381 894,400 L894,521 L767,521 Z"
                    :style="{ fill: '#c8e6c9' }" data-v-549317c7=""></path>{" "}
                <path d="M1021,521 C1020.99826,454.280117 964.169029,400.18381 894,400 L894,521 L1021,521 Z"
                    :style="{ fill: '#4caf50' }" data-v-549317c7=""></path>{" "}
                <path d="M894,521 C894.001743,587.721076 950.830971,641.817349 1021,642 L1021,521 L894,521 Z"
                    :style="{ fill: '#4caf50' }" data-v-549317c7=""></path>{" "}
                <path
                    ...
                    :style="{ fill: '#2196f3' }" data-v-549317c7=""></path>{" "}
                <path d="M127,92 C126.808812,158.855618 70.022547,213 0.00399756396,213 L0,213 L0,92 L127,92 Z"
                    transform="translate(63.500000, 152.500000) scale(-1, 1) translate(-63.500000, -152.500000) "
                    :style="{ fill: '#ffa000' }" data-v-549317c7=""></path>{" "}
                <path d="M254,92 C183.970093,92.0016605 127.191187,146.146043 127,213 L254,213 L254,92 Z"
                    transform="translate(190.500000, 152.500000) scale(-1, 1) translate(-190.500000, -152.500000) "
                    :style="{ fill: '#ff6f00' }" data-v-549317c7=""></path>{" "}
                <path d="M254,334 C183.970093,333.998173 127.191187,279.853774 127,213 L254,213 L254,334 Z"
                    transform="translate(190.500000, 273.500000) scale(-1, 1) translate(-190.500000, -273.500000) "
                    :style="{ fill: '#c8e6c9' }" data-v-549317c7=""></path>{" "}
                <path d="M177,334 C176.808812,267.145894 120.022547,213 50.0039976,213 L50,213 L50,334 L177,334 Z"
                    transform="translate(113.500000, 273.500000) scale(-1, 1) translate(-113.500000, -273.500000) "
                    :style="{ fill: '#2e7d32' }" data-v-549317c7=""></path>{" "}
                <path
                ...
                <polygon
                    ...
                    :style="{ fill: '#2e7d32' }" data-v-549317c7=""></polygon>{" "}
                <path
                ...
                <path
                    ...
                    :style="{ fill: '#ff6f00' }" data-v-549317c7=""></path>{" "}
                <path d="M220,418 L50,418 C50,511.88835 126.11049,588 220,588 L220,418 Z" :style="{
                    fill: '#ff6f00'
                }" data-v-549317c7=""></path>{" "}
                <path d=" M390,418 L390,588 L560,588 C560,494.11165 483.889849,418 390,418 Z"
                    :style="{ fill: '#2e7d32' }" data-v-549317c7=""></path>{" "}
                <polygon points="220 588 390 588 390 418 220 418" :style="{ fill: '#2e7d32' }" data-v-549317c7="">
                </polygon>{" "}
                <path d="M220,418 L50,418 C50,464.862003 69.0266665,507.289154 99.7901508,538 L220,418 Z" fill="#FFF000"
                    id="Fill-5" data-v-549317c7=""></path>{" "}
                <path d="M390,418 L390,588 L510,467.791064 C479.291766,437.027761 436.864012,418 390,418 Z"
                    :style="{ fill: '#2e7d32' }" data-v-549317c7=""></path>{" "}
                <path d="M810,545.4659 L894.4648,545.4659 L894.4648,461 C847.8164,461 810,498.8167 810,545.4659 Z"
                    :style="{ fill: '#4caf50' }" data-v-549317c7=""></path>{" "}
                <path
