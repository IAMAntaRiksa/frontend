<template>
    <section class="w-full ">
        <div class="container max-w-6xl mx-auto px-4 py-8">
            <div class="relative ">
                <div class="w-full absolute overflow-hidden" :style="{ height: '800px' }">
                    <div class="mx-auto mt-24 bg-green-600 opacity-25 rounded-full overflow-hidden" :style="{
                        height: '1080px', width: '1080px'
                    }"></div>
                </div>
            </div>
            <div class="max-w-3xl mb-24 relative mx-auto">
                <div class="absolute w-full top-8 z-20">
                    <div class="h-36 bg-slate-100 shadow-lg rounded-xl lg:h-64"></div>
                    <div class="top-0 px-8 w-full absolute flex items-center lg:justify-start">
                        <div class="w-48 mr-8 hidden border-8 border-black rounded-2xl lg:block">
                            <img src="@/assets/img/info/phone.png" alt="" class="w-full rounded-2xl" />
                        </div>
                        <div class="mx-auto lg:mx-0">
                            <h4 class="mb-8 text-2xl font-medium text-green-800 text-center lg:text-4xl lg:text-left">
                                Dapatkan Aplikasi Versi Mobile
                            </h4>
                            <div class="flex items-center">
                                <a href="/" class="h-16 mr-2">
                                    <img src="@/assets/img/info/app-store.png" alt="" class="h-full" />
                                </a>
                                <a href="/" class="h-16 ml-2">
                                    <img src="@/assets/img/info/play-store.png" alt="" class="h-full" />
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="-ml-16 hidden lg:block">
                    <svg width="400px" height="200px" viewBox="0 0 394 399" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        data-v-3c0c7bd2="">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" data-v-3c0c7bd2="">
                            <g class="deco-left" data-v-3c0c7bd2="">
                                ...
                                <path
                                    ...
                                    :style="{ fill: '#fa000' }" data-v-3c0c7bd2=""></path>{" "}
                                <path d="M146,53 C105.746589,53.0009606 73.1098949,84.324157 73,123 L146,123 L146,53 Z"
                                ...
                                <path
                                    ...
                                    :style="{ fill: '#e7d32' }" data-v-3c0c7bd2=""></path>{" "}
                                <path
                                ...
                                <path d="M239.5,321 L162.5,321 C162.5,364.078184 196.973575,399 239.5,399 L239.5,321 Z"
                                    :style="{ fill: '#f6f00' }" data-v-3c0c7bd2=""></path>{" "}
                                <path d="M316.5,321 L316.5,399 L393.5,399 C393.5,355.921816 359.026579,321 316.5,321 Z"
                                    :style="{
                                        fill: '#caf50'
                                    }" data-v-3c0c7bd2=""></path>{" "}
                                <polygon fill="#2E7D32" points="239.5 399 316.5 399 316.5 321 239.5 321"
                                    :style="{ fill: '#2e7d32' }" data-v-3c0c7bd2=""></polygon>{" "}
                                <path
                                    d="M239.5,321 L162.5,321 C162.5,342.478418 171.117961,361.924195 185.052009,376 L239.5,321 Z"
                                    id="Fill-4" fill="#FFF000" data-v-3c0c7bd2=""></path>{" "}
                                <path
                ...
                <div class="absolute -right-12 top-4 hidden z-40 lg:block">
                    <svg width="118px" height="315px" viewBox="0 0 118 315" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        data-v-3c0c7bd2="">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" data-v-3c0c7bd2="">
                            <g class="deco-right" data-v-3c0c7bd2="">
                                <path d="M0,0 C17.6808245,0.0451621733 32,13.4591488 32,29.9991789 L32,30 L0,30 L0,0 Z"
                                    :style="{ fill: '#caf50' }" data-v-3c0c7bd2=""></path>{" "}
                                <path d="M0,30 C0.000439144218,47.0934857 14.3196147,60.9529082 32,61 L32,30 L0,30 Z"
                                    :style="{
                                        fill: '#e7d32'
                                    }" data-v-3c0c7bd2=""></path>{" "}
                                <path d="M64,30 C63.9995609,47.0934857 49.6803853,60.9529082 32,61 L32,30 L64,30 Z"
                                    :style="{ fill: '#fa000' }" data-v-3c0c7bd2=""></path>{" "}
                                <path
                                ...
                                <path
                                    ...
                                    :style="{ fill: '#8e6c9' }" data-v-3c0c7bd2=""></path>{" "}
                                <path
                                ...
                                <path
                                    ...
                                    :style="{ fill: '#caf50' }" data-v-3c0c7bd2=""></path>{" "}
                                <path d="M48,277 L76,277 L76,249 C60.5361002,249 48,261.536036 48,277 Z"
                                    :style="{ fill: '#4caf50' }" data-v-3c0c7bd2=""></path>
                            </g>
                        </g>
                    </svg>
                </div>
            </div>
            <div class="w-full mt-56 pb-8 relative lg:mt-0">
                <div class="flex flex-col justify-center items-center">
                    <h2 class="mb-8 text-3xl font-medium text-black text-center lg:text-4xl">
                        Apa yang anda tunggu?
                    </h2>
                    <button
                        class="px-2 py-4 text-base font-normal text-white border-2 bg-orange-400 rounded-md hover:bg-orange-50">
                        BERGABUNG SEKARANG
                    </button>
                </div>
                <div class="h-56 -mt-16 hidden absolute md:block">
                    <img src="@/assets/img/info/plant.png" alt="" class="h-full opacity-40" />
                </div>
            </div>
        </div>
    </section>
